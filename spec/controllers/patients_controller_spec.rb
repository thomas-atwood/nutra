...
describe PatientsController do
  ...
  let(:valid_attributes) { { "issues_mood" => "false" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved patient as @patient" do
        ...
        post :create, {:patient => { "issues_mood" => "invalid value" }}, valid_session
        assigns(:patient).should be_a_new(Patient)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested patient" do
        ...
        Patient.any_instance.should_receive(:update_attributes).with({ "issues_mood" => "false" })
        put :update, {:id => patient.to_param, :patient => { "issues_mood" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the patient as @patient" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Patient.any_instance.stub(:save).and_return(false)
        put :update, {:id => patient.to_param, :patient => { "issues_mood" => "invalid value" }}, valid_session
        assigns(:patient).should eq(patient)
      end
